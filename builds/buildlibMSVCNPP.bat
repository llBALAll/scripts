...
rem SET "COMPILEROPTS=/c /Zc:wchar_t /W1 /O2 /fp:precise /Gd /GS /Gm- /Zc:inline /errorReport:prompt /WX- /FC /EHsc"
rem linkar dinamicamente as dlls do runtime do windows
SET "COMPILEROPTS=/c /Zc:wchar_t /W1 /O2 /fp:precise /Gd /GS /MD /Gm- /Zc:inline /errorReport:prompt /WX- /FC /EHsc"
